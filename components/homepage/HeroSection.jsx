...
const GALLERY_TILES = [
  {
    ...
    gradient: 'linear-gradient(145deg, #1648D6 0%, #0a278a 100%)',
    tall: true,
    img: null,
  },
  {
    ...
    gradient: 'linear-gradient(145deg, #1e3660 0%, #0E1B2E 100%)',
    tall: false,
    img: null,
  },
  {
    ...
    gradient: 'linear-gradient(145deg, #2A3A53 0%, #141c2b 100%)',
    tall: false,
    img: null,
  },
]
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20 xl:gap-24">
          ...
          <div className="max-w-[760px]">
            ...
            <div className="mt-10 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
              <Link
                href="#categories"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-[4px] bg-brand px-5 text-[14px] font-semibold text-white transition-colors hover:bg-brand-2"
              >
                Prezrieť produkty
          ...
          <div className="relative pb-4 lg:self-end lg:pb-10">
            <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2 lg:grid-rows-[230px_145px]">
              {GALLERY_TILES.map((tile) => (
                <div
                  key={tile.label}
                  className={[
                    'relative flex min-h-[180px] cursor-pointer flex-col justify-end overflow-hidden rounded-lg p-5 transition-transform hover:scale-[1.015] sm:min-h-0',
                    tile.tall
                ...
                >
                  ...
                  <div className="relative z-10">
                    <span className="mb-1.5 block font-[family-name:var(--font-ibm-plex-mono)] text-[10px] uppercase tracking-widest text-white/60">
                      {tile.label}
                    </span>
            ...
            {/* Floating badge */}
            <div className="absolute -top-4 right-3 flex items-center gap-2 rounded-md border border-line bg-white px-3.5 py-2.5 shadow-[0_4px_20px_rgba(14,27,46,0.12)] sm:-right-4">
